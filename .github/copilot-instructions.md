...
- **Source of truth**: `scripts/miniblue-image.mjs` exports the canonical image tag (e.g. `ghcr.io/lonegunmanb/miniblue:sha-cf2cb7f`).
- **Auto-propagated**: `scripts/sync-miniblue-image.mjs` rewrites every `image: ghcr.io/lonegunmanb/miniblue:sha-cf2cb7f` line in `terraform-tutorial/*/assets/docker-compose.yml`, `terraform-tutorial/*/init/background.sh`, and the docs reference in this file.

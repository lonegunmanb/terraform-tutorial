...
| `yandex-cloud/yandex` | `registry.terraform.io/yandex-cloud/yandex` | Yandex Cloud Provider |
...
- `yandex_compute_instance` → 寻找本地名称为 `yandex` 的 Provider
...
# 当资源类型以 yandex_ 开头时，Terraform 尝试寻找 hashicorp/yandex
resource "yandex_compute_instance" "web" {
  name = "web-server"
}
# terraform init 报错：
# Could not retrieve the list of available versions for provider
# hashicorp/yandex: provider registry registry.terraform.io does
# not have a provider named registry.terraform.io/hashicorp/yandex
```

...
输出是一个 DOT 格式的文本图，可以看到 azurerm_resource_group.setup 和 azurerm_resource_group.deploy 之间的 depends_on 依赖关系，以及新增的 module.greeting 节点。
...
```bash
grep -E 'azurerm_resource_group|module' /tmp/graph.dot
```
